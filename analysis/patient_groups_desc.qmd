...
#     theme_bw()  + facet_grid(~currently_treated_new) 

ggplot(vax_resp_data,aes(days_since_2nd_dose, response, col=currently_treated_new, group=interaction(ptgroup,ptid_4))) + 
    geom_line(aes(y=fit), size=0.1)  +
    #geom_hline(yintercept=0, linetype="dashed") +
    theme_bw() 
